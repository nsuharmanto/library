        ...
        <div className="hidden md:flex flex-1 justify-center px-8">
          <div className="relative w-full max-w-md flex items-center">
            ...
            <input
              ...
              className="w-full rounded-full border border-gray-300 pl-12 pr-4 py-2 focus:outline-none focus:ring-1 focus:ring-primary-300"
              style={{ marginLeft: "0" }}
            />
          </div>
        </div>
      ...
      <div className="flex items-center gap-4">
        ...
        {isLoggedIn && (
          <button className="relative">
            <img src="/icons/bag.svg" alt="Cart" className="w-8 h-8" />
            {/* Badge data borrowed */}
          </button>
        )}
        ...
        {isLoggedIn && (
          <div className="relative flex items-center gap-4" ref={dropdownRef}>
            {/* Avatar + name (desktop), avatar only (mobile) */}
            <button
              className="flex items-center gap-2 focus:outline-none"
            ...
            >
              ...
              />
              <span className="hidden md:inline text-text-lg font-semibold text-gray-900">{userName || "User"}</span>
              ...
              <>
                ...
                >
                  <ul className="py-2">
                    ...
                    <li>
                      <button className="w-full text-left px-5 py-2 hover:bg-gray-100 text-gray-950 font-semibold">Borrowed List</button>
                    </li>
                    <li>
                      <button className="w-full text-left px-5 py-2 hover:bg-gray-100 text-gray-950 font-semibold">Reviews</button>
                    </li>
                    <li>
                      <button
                ...
                >
                  <ul className="py-4">
                    ...
                    <li>
                      <button className="w-full text-left px-6 py-3 text-lg hover:bg-gray-100 text-gray-900 font-normal">Borrowed List</button>
                    </li>
                    <li>
                      <button className="w-full text-left px-6 py-3 text-lg hover:bg-gray-100 text-gray-900 font-normal">Reviews</button>
                    </li>
                    <li>
                      <button
